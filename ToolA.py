...
app.layout = html.Div(style={'background-color':'#124654' },children=[header1,
         html.Br(),html.Div([ dbc.Row([ dbc.Col([ "Input Requirement: "],width={"size": 1}, style={'align-items':'left','margin-left': '2%' }),
...
def gg(id_button,capabilities,my_input,domain_id,accuracy_id):
    ...
    if 'id_button' in changed_id:
        ...
        dis = pd.DataFrame({'Index':range(1,len(data)+1),'Capabilities':data,'Accuracy':accu})
